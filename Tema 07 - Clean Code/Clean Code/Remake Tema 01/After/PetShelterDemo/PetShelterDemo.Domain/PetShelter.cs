...
public class PetShelter
{
    ...
    public void DonationAmountsForPetShelter(int amountInRON, int amountInEURO)
    {
        donationsInRon += amountInRON;
        donationsInEuro += amountInEURO;
    }

    public void MakeDonationToPetshelter(Donations donor, int amountInRON, int amountInEURO)
    {
        donorRegistry.Register(donor);
        DonationAmountsForPetShelter(amountInRON, amountInEURO);
    }
