...
namespace PetShelter.DataAccessLayer.Migrations
{
    ...
    [Migration("20230219193559_AddFundraiserTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetShelter.DataAccessLayer.Models.DonationFundraiser", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id", "DonationId", "FundraiserId");

                    b.HasIndex("DonationId");

                    b.HasIndex("FundraiserId");

                    b.ToTable("DonationFundraisers");
                });
            ...
            modelBuilder.Entity("PetShelter.DataAccessLayer.Models.DonationFundraiser", b =>
                {
                    b.HasOne("PetShelter.DataAccessLayer.Models.Donation", "donation")
                        .WithMany("donationFundraisers")
                        .HasForeignKey("DonationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PetShelter.DataAccessLayer.Models.Fundraiser", "fundraiser")
                        .WithMany("fundraisersDonation")
            ...
            modelBuilder.Entity("PetShelter.DataAccessLayer.Models.Donation", b =>
                {
                    b.Navigation("donationFundraisers");
                });

            modelBuilder.Entity("PetShelter.DataAccessLayer.Models.Fundraiser", b =>
                {
                    b.Navigation("fundraisersDonation");
                });
